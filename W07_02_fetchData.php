...
if ($result->rowCount() > 0) {
    ...
    //echo "<h2>พบ ข้อมูลในตราราง Product</h2>";
...
//------------------------------------------------------------
    //ใช่ prepard statement เพื่อดป้องกัน SQL Injection
    //ใช่ execute()  เพื่อรันคำสั่ง SQL
    //ใช้ fetcAll() เพื่อดึงข้อมูลทั้งหมดในครั้งเดียว
    //ใช่ print_r() เพื่อแสดงข้อมูลทั้งหมดในรูปแบบ array
